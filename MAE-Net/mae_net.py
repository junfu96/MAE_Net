...
class mae_net:
    ...
    def init(self, args, len_dataset):
        ...
        self.G_lr_scheduler = module.LinearDecay(args['lr'], args['epochs'] * len_dataset,
                                                 args['epoch_decay'] * len_dataset)
        self.D_lr_scheduler = module.LinearDecay(args['lr'], args['epochs'] * len_dataset,
                                                 args['epoch_decay'] * len_dataset)
        ...
        self.set_G_A2B(input_shape=(args['crop_size'], args['crop_size'], 3), n=args['n'])
        self.set_G_B2A(input_shape=(args['crop_size'], args['crop_size'], 3), n=args['n'])
        self.set_D_A(input_shape=(args['crop_size'], args['crop_size'], 3), n=args['n'])
        self.set_D_B(input_shape=(args['crop_size'], args['crop_size'], 3), n=args['n'])

    def set_G_A2B(self, input_shape, n):
        if self.filter == 'operational':
            self.G_A2B = module.OpGenerator(input_shape=input_shape, n=n)
    ...
    def set_G_B2A(self, input_shape, n):
        if self.filter == 'operational':
            self.G_B2A = module.OpGenerator(input_shape=input_shape, n=n)
        elif self.filter == 'convolutional':
    ...
    def set_D_A(self, input_shape, n):
        if self.filter == 'operational':
            self.D_A = module.OpDiscriminator(input_shape=input_shape, n=n)
        elif self.filter == 'convolutional':
    ...
    def set_D_B(self, input_shape, n):
        if self.filter == 'operational':
            self.D_B = module.OpDiscriminator(input_shape=input_shape, n=n)
        elif self.filter == 'convolutional':
    ...
    def train_G(self, A, B):
        with tf.GradientTape() as t:
            ...
            G_loss = (A2B_g_loss + B2A_g_loss + (0.1 * (A2B_c_loss + B2A_c_loss))) + (
                    ...
                    0.01 * (A2B2A_c_loss + B2A2B_c_loss))) * self.cycle_weights + (
